...
#define kRWSearchCaseSensitiveKey @"Case Sensitive"
#define kRWSearchWholeWordsKey @"Search Whole Words"
...
{
    NSDictionary *options = @{kRWSearchCaseSensitiveKey:@NO, kRWSearchWholeWordsKey:@NO};
    return [DIHelpers regularExpressionWithString:string options:options];
}

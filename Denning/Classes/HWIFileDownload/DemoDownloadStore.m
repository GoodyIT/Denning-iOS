...
- (void)setupDownloadItems:(NSArray*) urls
{
    self.downloadItemsArray = [self restoredDownloadItems];
    
    // setup items to download
    for (NSUInteger aDownloadIdentifierUInteger = 1; aDownloadIdentifierUInteger < urls.count+1; aDownloadIdentifierUInteger++)
    {
        ...
        {
            NSURL *aRemoteURL = urls[aDownloadIdentifierUInteger-1];
                             ...
                             localFileURL:(nonnull NSURL *)aLocalFileURL
{
    ...
    if (aFoundDownloadItemIndex != NSNotFound)
    {
        ...
        aCompletedDownloadItem.localURL = aLocalFileURL;

...
+(NSArray*) getSolicitorGroupArrayFromResponse: (NSArray*) response
{
    ...
    for (id group in response) {
        ...
        solicitorGroup.solicitorGroupName = [group valueForKeyNotNull:@"groupName"];
        ...
        if ([solicitor isKindOfClass:[NSNull class]]) {
            ...
            solicitorGroup.solicitorCode = [solicitor valueForKeyNotNull:@"code"];
            solicitorGroup.solicitorName = [solicitor valueForKeyNotNull:@"name"];
            solicitorGroup.solicitorReference = [group valueForKeyNotNull:@"reference"];
        }

...
//  Q-municate
//
//  Created by Vitaliy Gorbachov on 1/6/16.
...
static NSString *const kQMSceneSegueSetting                 = @"SceneSegueSettings";
...
static NSString *const kOpenFileSegue = @"OpenFileSegue";
...
static NSString *const kQMSceneSegueNews                    = @"SceneSegueNews";

static NSString *const kPostPublishType                     = @"createPospPopUpSegue";
static NSString *const kProfileSegue                        = @"ProfileSegue";
static NSString *const kNewPostSegue                        = @"NewPostSegue";
static NSString *const kCommentSegue                        = @"CommentSegue";
static NSString *const kHashTagSegue                        = @"HashTagSegue";
static NSString *const kNewsFeedSegue                       = @"NewsFeedSegue";
static NSString *const kGroupSegue                          = @"GroupSegue";
static NSString *const kNewGroupSegue                       = @"NewGroupSegue";
static NSString *const kGroupDetailSegue                    = @"GroupDetailSegue";
static NSString* const kTopicReplySegue                     = @"TopicReplySegue";
static NSString* const kEditJournalSegue                    = @"EditJournalSegue";
static NSString* const kUserListSegue                       = @"UserListSegue";
...
static NSString* const kDenningSupportSegue = @"DenningSupportSegue";

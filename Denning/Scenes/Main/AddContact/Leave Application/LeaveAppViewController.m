...
- (void) prepareUI {
    ...
    _topFilter = @[@"Leave Application", @"Leave Record"];
...
- (void) loadLeaveRecords {
    [SVProgressHUD show];
    [[QMNetworkManager sharedManager] getLeaveRecordsWithPage: _page completion:^(NSDictionary * _Nonnull result, NSError * _Nonnull error) {

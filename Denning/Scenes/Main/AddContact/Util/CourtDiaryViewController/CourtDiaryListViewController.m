...
@interface CourtDiaryListViewController ()
...
@implementation CourtDiaryListViewController
...
- (void) getList {
    ...
    @weakify(self)
    [[QMNetworkManager sharedManager] getCourtDiaryArrayWithPage:self.page withSearch:(NSString*)self.filter WithCompletion:^(NSArray * _Nonnull result, NSError * _Nonnull error) {
